...
RUN wget --no-verbose -O /tmp/chromedriver_linux64.zip https://chromedriver.storage.googleapis.com/index.html?path=98.0.4758.48/ \
...
# NodeJS
#==========
RUN curl -SLO https://nodejs.org/dist/latest/node-v17.4.0-linux-x64.tar.gz\
